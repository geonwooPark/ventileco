...
export default function SideInfoButton({
  ...
  return (
    <button
      ...
      className={`absolute right-[320px] top-[96px] z-[11] flex h-11 w-11 items-center justify-center rounded-l-md text-gray-700 transition-transform duration-200 ease-in-out md:top-[118px] ${
        showSideInfo
