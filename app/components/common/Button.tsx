...
const btnLevel = {
  primary: `bg-brown-normal shadow-md text-beige-normal font-point rounded transition duration-200 ease-in-out hover:opacity-90 disabled:opacity-40 disabled:cursor-not-allowed`,
